"""
DNA dataset preprocessing (from libsvm).
- libsvm format: already numeric, no missing values
- train: 2000 samples, test: 1186 samples, 180 features, 3 classes
...
X_tr, y_tr = load_svmlight_file(os.path.join(raw_dir, "dna", "dna.scale.tr"))
X_t, y_t = load_svmlight_file(os.path.join(raw_dir, "dna", "dna.scale.t"), n_features=X_tr.shape[1])
...
out_path = os.path.join(get_dir_in_root("dataset"), "DNA.csv")
