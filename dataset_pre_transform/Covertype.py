"""
Covertype dataset preprocessing.
- dict format: features, targets
- 581012 samples, 54 features
- 7 classes: 1-7
- No nulls, no categorical columns (already numeric)
"""
import os
import pickle
import sys
...
path = os.path.join(path, "Covertype.pkl")
...
path = os.path.join(path, "Covertype.csv")
