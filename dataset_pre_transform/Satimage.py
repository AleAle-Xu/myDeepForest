"""
Satimage dataset preprocessing (from libsvm).
- libsvm format: already numeric, no missing values
- train: 4435 samples, test: 2000 samples, 36 features, 6 classes
...
X_tr, y_tr = load_svmlight_file(os.path.join(raw_dir, "satimage", "satimage.scale"))
X_t, y_t = load_svmlight_file(os.path.join(raw_dir, "satimage", "satimage.scale.t"), n_features=X_tr.shape[1])
...
out_path = os.path.join(get_dir_in_root("dataset"), "Satimage.csv")
